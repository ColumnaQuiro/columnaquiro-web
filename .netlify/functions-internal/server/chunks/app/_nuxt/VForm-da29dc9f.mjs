import { createVNode, computed, ref, toRef, watch, mergeProps, withDirectives, vShow, Fragment, resolveDirective, cloneVNode, useSSRContext, provide, unref, nextTick, defineComponent, isRef, inject } from 'vue';
import { ssrRenderComponent } from 'vue/server-renderer';
import { V as VExpandXTransition, a as VSlideYTransition } from './index-332a78af.mjs';
import { g as genericComponent, m as makeThemeProps, p as propsFactory, I as IconValue, E as EventProp, a as provideTheme, h as getUid, c as convertToUnit, w as wrapInArray, i as useProxiedModel, j as filterInputAttrs, k as useLocale, l as getCurrentInstanceName, n as isOn, o as pick, q as consoleWarn, r as useToggleScope, s as callEvent } from '../server.mjs';
import { f as makeLoaderProps, h as useLoader, j as useBackgroundColor, l as useTextColor, L as LoaderSlot, m as makeDensityProps, u as useDensity, k as VIcon } from './loader-3f4a27a1.mjs';
import { u as useRender, m as makeTransitionProps, M as MaybeTransition, I as Intersect$1 } from './transition-ee3007a2.mjs';
import { a as SLACK_SERVICES_URL } from './urls-0c5c04f3.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    type: { default: "text" },
    appendInnerIcon: { default: void 0 }
  },
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VTextField, mergeProps({
        ...
        type: __props.type,
        rules: __props.required ? unref(REQUIRED_RULE) : __props.rules,
        ...
        variant: "outlined",
        class: "input-text",
        "onClick:appendInner": ($event) => emit("click:appendInner")
      }, _attrs), null, _parent));
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/cq/components/InputText.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const useSendSlackMessage = async ({ channel, text }) => {
...
const EMAIL_SUBSCRIPTION_CHANNEL = "T04L0D5C8TC/B04NWJUB0M9/0BQBcTofnsPbfN2o37XvbODf";
const CONTACT_FORM_CHANNEL = "T04L0D5C8TC/B04PHU4L0R3/0X6pbKsT3A13AzJbo4MDgE5q";
...
export { CONTACT_FORM_CHANNEL as C, EMAIL_RULES as E, REQUIRED_RULE as R, VForm as V, _sfc_main as _, EMAIL_SUBSCRIPTION_CHANNEL as a, useSendSlackMessage as u };
//# sourceMappingURL=VForm-da29dc9f.mjs.map
