import { h, getCurrentInstance as getCurrentInstance$1, effectScope, inject as inject$1, onMounted, onUnmounted, shallowRef, ref, computed, onBeforeMount, watch, Fragment as Fragment$1, isRef, createVNode, Text, version as version$1, reactive, watchEffect, toRefs, capitalize, onScopeDispose, defineComponent as defineComponent$1, unref, provide, mergeProps, toRaw, isReadonly, useSSRContext, createApp, toRef, nextTick, onErrorCaptured, onServerPrefetch, defineAsyncComponent, withCtx, Suspense, Transition } from 'vue';
...
import { makeSymbol, assign, isNumber, isString, isObject as isObject$2, isBoolean, isEmptyObject, isArray, isPlainObject, isRegExp, isFunction, getGlobalThis, hasOwn, inBrowser } from '@intlify/shared';
...
const Translation =  /* defineComponent */ {
    ...
    setup(props, context) {
        ...
        return () => {
            ...
            const tag = isString(props.tag) || isObject$2(props.tag)
                ? props.tag
                : getFragmentableTag();
...
function getI18nInstance(instance) {
    {
        const i18n = inject$1(!instance.isCE
            ? instance.appContext.app.__VUE_I18N_SYMBOL__
            : I18nInjectionKey);
        /* istanbul ignore if */
        if (!i18n) {
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1.0" }, { "charset": "utf-8" }], "link": [], "style": [], "script": [], "noscript": [], "charset": "utf-8", "viewport": "width=device-width, initial-scale=1.0" };
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/aviso-legal-b68cb016.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-17615abd.mjs').then((m) => m.default || m)
  },
  {
    name: "para-quien-sirve-la-quiropractica-type",
    path: "/para-quien-sirve-la-quiropractica/:type",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_type_-ff1ebb16.mjs').then((m) => m.default || m)
  },
  {
    name: "para-quien-sirve-la-quiropractica",
    path: "/para-quien-sirve-la-quiropractica",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-5d0a839e.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/politica-de-cookies-72d84e78.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/politica-de-privacidad-5def74b6.mjs').then((m) => m.default || m)
  },
  {
    name: "que-es-la-quiropractica",
    path: "/que-es-la-quiropractica",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0cdbf828.mjs').then((m) => m.default || m)
  },
  {
    name: "que-es-la-quiropractica-preguntas-frecuentes",
    path: "/que-es-la-quiropractica/preguntas-frecuentes",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/preguntas-frecuentes-647219ea.mjs').then((m) => m.default || m)
  },
  {
    name: "reserva-cita-centro-quiropractico-valencia",
    path: "/reserva-cita-centro-quiropractico-valencia",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/reserva-cita-centro-quiropractico-valencia-a42432f6.mjs').then((m) => m.default || m)
  },
  {
    name: "servicios-quiropractica",
    path: "/servicios-quiropractica",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0ed4bd21.mjs').then((m) => m.default || m)
  },
  {
    name: "servicios-quiropractica-primera-visita",
    path: "/servicios-quiropractica/primera-visita",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/primera-visita-ee509a22.mjs').then((m) => m.default || m)
  },
  {
    name: "sobre-nosotros-centro-quiropractico-valencia",
    path: "/sobre-nosotros/centro-quiropractico-valencia",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/centro-quiropractico-valencia-798217cc.mjs').then((m) => m.default || m)
  },
  {
    name: "sobre-nosotros-contacto",
    path: "/sobre-nosotros/contacto",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contacto-b64a0be7.mjs').then((m) => m.default || m)
  },
  {
    name: "sobre-nosotros-equipo",
    path: "/sobre-nosotros/equipo",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/equipo-a42ce325.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/terminos-y-condiciones-5821cafd.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-0e3581e1.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-78eba626.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-bccdc26d.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const server = /*#__PURE__*/Object.freeze({
  ...
  x: deepEqual,
  y: wrapInArray,
  z: findChildrenWithProvide
});

export { isObject as A, keyCodes as B, destructComputed as C, includes as D, EventProp as E, useIcon as F, isCssColor as G, createError as H, IconValue as I, useNuxtApp as J, useRouter as K, navigateTo as L, server as M, SUPPORTS_INTERSECTION as S, _export_sfc as _, provideTheme as a, provideDefaults as b, convertToUnit as c, useDisplay as d, defineComponent as e, useRoute as f, genericComponent as g, getUid as h, useProxiedModel as i, filterInputAttrs as j, useLocale as k, getCurrentInstanceName as l, makeThemeProps as m, isOn as n, pick as o, propsFactory as p, consoleWarn as q, useToggleScope as r, callEvent as s, useRtl as t, useI18n as u, getCurrentInstance as v, wrapInArray as w, findChildrenWithProvide as x, deepEqual as y, hasEvent as z };
