<template>
  <cq-layout-section>
    ...
    <br><br>
    El presente Aviso Legal regula el uso del sitio web www.columnaquiro.com siendo su titular Léa Guido con NIE Y7115191V.
    <br><br>
    <div class="text-xl font-medium pb-3">
    ...
    <ul class="list-disc">
      <li>
        Identidad del Responsable: Léa Guido
      </li>
      <li>
        NIE: Y7115191V
      </li>
      <li>
        Correo electrónico: lea@columnaquiro.com
      </li>
      <li>
        Dirección: Calle dels Vivons 29, bajo izquierda, 46004 Valencia
      </li>
      <li>
        Teléfono: 744735362
      </li>
    </ul>
    Léa Guido en relación a la protección de datos de acuerdo con los requisitos de la legislación vigente:
    <br><br>
    <ul class="list-disc">
      <li>
    ...
    En cumplimiento de lo dispuesto en el Reglamento Europeo 2016/679 de Protección de Datos de Carácter Personal, RGPD, y la Ley Orgánica 3/2018, LOPD-GDD, Léa Guido, le informa que, los datos de carácter personal que nos proporcione a través de nuestro formulario de Contacto en nuestra página web, se recogerán en nuestras bases de datos siendo responsable Léa Guido.
    <br><br>
    Podrá ejercer sus derechos de acceso, rectificación, portabilidad y supresión de sus datos y los de limitación y oposición a su tratamiento en los términos y en las condiciones previstas en la normativa legal vigente, dirigiéndose por escrito a Léa Guido situada en Calle dels Vivons 29, bajo izquierda, 46004 Valencia si lo prefiere con un e-mail a lea@columnaquiro.com.
    <br><br>
    De conformidad con el artículo 32 del RGPD y con el marco normativo general de protección de datos, Léa Guido ha adoptado las medidas de seguridad, técnicas, organizativas y de control proactivo necesarias. Todo ello, en función del análisis previo del riesgo de las operaciones de tratamiento realizadas.
    <br><br>
    Léa Guido se compromete a llevar un registro de las actividades de tratamiento tal como se dispone en el artículo 30.2 del RGPD.
    <br><br>
    Le rogamos que comunique inmediatamente a Léa Guido cualquier modificación de sus datos de carácter personal para que la información que contienen nuestros ficheros esté siempre actualizada y no contenga errores.
    <br><br>
    Asimismo, con la aceptación de este Aviso Legal reconoce que la información y los datos personales recogidos son exactos y veraces. La recogida de sus datos de carácter personal se realiza con el fin de prestar los servicios solicitados y remitirle información sobre la entidad u ofertas comerciales de otros productos y servicios, avisos y, en general, información de Léa Guido que pueda ser de su interés. De conformidad con lo previsto en la normativa actual vigente, en rellenar cualquiera de los formularios que aparecen en nuestra página web, da su consentimiento para que sus datos sean tratados, con el fin de dirigir información, siempre en el ámbito de las funciones legítimas de cedente y cesionario.
    <br><br>
    También autoriza a Léa Guido para que puedan remitirle comunicaciones comerciales a través del correo electrónico o de cualquier otro medio de comunicación electrónica equivalente. Las autorizaciones para el envío de información comercial, cesión de datos y envío de comunicaciones comerciales por medios electrónicos serán revocables, en cualquier momento, mediante comunicación escrita dirigida a Léa Guido a la dirección antes mencionada, en la que deberá indicar los siguientes datos para su identificación: nombre y dirección.
    <br><br>
    Léa Guido se compromete a tratar de forma absolutamente confidencial sus datos de carácter personal y utilizarlo sólo para las finalidades indicadas.
    <br><br>
    Léa Guido informa que procederá a tratar los datos de manera lícita, leal, transparente, adecuada, pertinente, limitada, exacta y actualizada. Es por ello que Léa Guido se compromete a adoptar todas las medidas razonables para que estos se supriman o rectifiquen sin dilación cuando sean inexactos.
    <br><br>
    Asimismo, le informamos que Léa Guido tiene implantadas las medidas técnicas y organizativas necesarias para garantizar la seguridad de sus datos de carácter personal y evitar su alteración, pérdida y tratamiento y / o acceso no autorizado, habida cuenta del estado de la tecnología, la naturaleza de los datos almacenados y los riesgos, provenientes de la acción humana o del medio físico y natural, a la que están expuestos.
    <br><br>
    <div class="text-xl font-medium pb-3">
    ...
    <br><br>
    Para el caso de existir enlaces con diferentes sitios web, Léa Guido, no se hará responsable de su contenido al carecer de control sobre los mismos.
    <br><br>
    El usuario cuando accede al sitio web, lo hace por su propia cuenta y riesgo. Léa Guido no garantiza ni la rapidez, ni la interrupción, ni la ausencia de virus en el sitio web. Asimismo, el titular del sitio web, los colaboradores, sus socios, empleados y representantes tampoco podrán ser considerados responsables por cualquier daño derivado de la utilización de este sitio web, ni por cualquier actuación realizada sobre la base de la información que en él se facilita
    <br><br>
    ...
    <br><br>
    El sitio web de Léa Guido proporciona gran diversidad de información, servicios y datos. El usuario asume su responsabilidad en el uso correcto del sitio web. Esta responsabilidad se extenderá a:
    <br><br>
    <ul class="list-disc">
      <li>
        La veracidad y licitud de las informaciones aportadas por el usuario en los formularios extendidos por Léa Guido para el acceso a ciertos contenidos o servicios ofrecidos por el web.
      </li>
      <li>
        El uso de la información, servicios y datos ofrecidos por Léa Guido contrariamente a lo dispuesto por las presentes condiciones, la Ley, la moral, las buenas costumbres o el orden público, o que de cualquier otro modo puedan suponer lesión de los derechos de terceros o del mismo funcionamiento del sitio web.
      </li>
      <li>
        Cualquier utilización distinta a la autorizada está expresamente prohibida, quedando Léa Guido facultado para denegar o retirar el acceso y uso de la Web, en cualquier momento, y sin previo aviso, a aquellos usuarios que incumplan estas condiciones generales.
      </li>
    </ul>
    ...
    El sitio web, incluyendo a título enunciativo pero no limitativo su programación, edición, compilación y demás elementos necesarios para su funcionamiento, los diseños, logotipos, texto y/o gráficos, son propiedad de Léa Guido o en su caso dispone de licencia o autorización expresa por parte de los autores.
    <br><br>
    ...
    <br><br>
    Los diseños, logotipos, texto y / o gráficos ajenos a Léa Guido y que pudieran aparecer en el sitio web, pertenecen a sus respectivos propietarios, siendo ellos mismos responsables de cualquier posible controversia que pudiera suscitarse respecto a estos. En todo caso Léa Guido cuenta con la autorización expresa y previa por parte de los mismos. Léa Guido reconoce a favor de sus titulares los correspondientes derechos de propiedad intelectual, no implicando su sola mención o aparición en el sitio web la existencia de derechos o responsabilidad alguna de prestador sobre los mismos, como tampoco respaldo, patrocinio o recomendación por éste.
    <br><br>
    El usuario puede utilizar el material que aparezca en este sitio web para su uso personal y privado, quedando prohibido su uso con fines comerciales. Léa Guido velará por el cumplimiento de las anteriores condiciones, como por la debida utilización de los contenidos presentados en sus páginas web, ejercitando todas las acciones civiles y penales que le corresponderán en el caos de infracción o incumplimiento de estos derechos por parte del usuario.
    <br><br>
    <div class="text-xl font-medium pb-3">
      Acciones legales, legislación aplicable y jurisdicción
    </div>
    Las presentes condiciones de uso se rigen por la legislación española, siendo competentes los Juzgados y Tribunales de la ciudad de Léa Guido para conocer de cuantas cuestiones se susciten sobre la interpretación, aplicación y cumplimiento de las mismas. Los usuarios, por virtud de su aceptación a las condiciones generales recogidas en este Aviso Legal, renuncian expresamente a cualquier fuero que, por aplicación de la Ley de Enjuiciamiento Civil vigente, pudiera corresponderles.
    <br><br>
    Léa Guido se reserva, asimismo, la facultad de presentar las acciones civiles o penales que considere oportunas por la utilización indebida de su sitio web y contenidos, o por el incumplimiento de las presentes condiciones.
    <br><br>
    La relación entre el usuario y el prestador se regirá por la normativa vigente y de aplicación en el territorio español. De surgir cualquier controversia las partes podrán someter sus conflictos a arbitraje o acudir a la jurisdicción ordinaria cumpliendo con las normas sobre jurisdicción y competencia al respecto. Léa Guido tiene su domicilio en Barcelona, España.
    <br><br>
    Los datos de carácter personal que nos has facilitado de forma voluntaria serán incorporados a un fichero del que es titular Léa Guido que se utilizará para gestionar tu suscripción a nuestro boletín a través del que te mantendremos informado de los productos, novedades, sorteos, servicios, eventos y promociones de la empresa Léa Guido con NIE Y7115191V, domicilio en Calle dels Vivons 29, bajo izquierda, 46004 Valencia y e-mail lea@columnaquiro.com, así como la gestión de su inscripción y participación en sorteos, concursos o eventos que solicite participar.
    <br><br>
    <div class="text-xl font-medium pb-3">
    ...
    <br><br>
    La base legal para el tratamiento de sus datos para la finalidad de poder informarle por vía electrónica sobre los productos, novedades, sorteos, servicios, eventos y promociones de Léa Guido así como la gestión de su inscripción y participación a sorteos, concursos o eventos que solicite, es la aportación del consentimiento. El consentimiento será válido hasta que decida revocarlo.
    <br><br>
    Cualquier persona tiene derecho a obtener confirmación sobre si Léa Guido está tratando datos personales que les conciernan o no.
    <br><br>
    Como responsable del fichero, la empresa se compromete a respetar la confidencialidad de tu información de carácter personal. Para ejercitar tus derechos de acceso, rectificación, cancelación y oposición deberás de remitir una comunicación desde la cuenta de correo electrónico que utilizaste para tramitar el alta a lea@columnaquiro.com con el asunto BAJA. Tramitar la suscripción al boletín presumirá tu consentimiento para tratar los datos en los términos indicados.
    <br><br>
    ...
    Ciertos contenidos de la website de Calle dels Vivons 29, bajo izquierda, 46004 Valencia contienen la posibilidad de contratación por Internet. El uso de los mismos requerirá la lectura y aceptación obligatoria de las condiciones generales de contratación establecidas al efecto por Léa Guido.
    <br><br>
    <div class="text-xl font-medium pb-3">
      Información básica
    </div>
    <ul class="list-disc">
      <li>
        Responsable del tratamiento:  Léa Guido
      </li>
      <li>
      ...
      <li>
        Derechos: para ejercer los derechos de acceso, rectificación, portabilidad y supresión de sus datos y los de limitación y oposición a su tratamiento reconocidos por la normativa, puede enviar un correo a lea@columnaquiro.com.
      </li>
      <li>
