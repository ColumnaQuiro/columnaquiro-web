...
{
  "es": {
    "title": "Reserva tu visita en ColumnaQuiro",
    "subtitle": "¡Hola! A continuación puedes reservar tu próxima visita en ColumnaQuiro. Ya sea primera visita o paciente frecuente.",
    "steps": {
